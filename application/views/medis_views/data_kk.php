<div class="content">
    <div class="table-responsive tile">
        ...
        <table class=" table table-dordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row text-center">
                            <div class="col-md-12">
                                <a class="btn btn-outline-primary col-lg-6" href="<?= site_url('medis/update_kk/' . md5($val['id_kk'])) ?>">update</a>
                            </div>
                            <div class="col-md-12">
                                <a class="btn btn-outline-danger col-lg-6" href="<?= site_url('medis/delete_kk/' . md5($val['id_kk'])) ?>"> delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <div class="row">
                <div class="col-md-3">
                    <form action="<?= base_url('medis/data_kk'); ?>" method="POST">
        ...
        <a href="<?= site_url('medis/input_kk') ?>" class="btn btn-lg btn btn-primary right-block">Tambah kk</a>
    </div>