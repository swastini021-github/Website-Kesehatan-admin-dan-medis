<div class="content">
    <div class="table-responsive tile">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row text-center">
                            <div class="col-md-12">
                                <a class="btn btn-outline-primary col-lg-8" href="<?= site_url('medis/update_penduduk/' . md5($val['id_penduduk'])) ?>">update</a>
                            </div>
                            <div class="col-md-12">
                                <a class="btn btn-outline-danger col-lg-8" href="<?= site_url('medis/delete_penduduk/' . md5($val['id_penduduk'])) ?>"> delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <a href="<?= site_url('medis/input_penduduk') ?>" class="btn btn-lg btn btn-primary right-block">Tambah penduduk</a>
    </div>
</div>