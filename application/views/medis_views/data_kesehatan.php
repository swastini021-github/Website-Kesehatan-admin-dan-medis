<div class="content">
    <div class="table-responsive tile">
                ...
                <tr>
                    ...
                    <td>
                        <div class="row text-center">
                            <div class="col-md-12">
                                <a class="btn btn-outline-primary col-lg-8" href="<?= site_url('medis/update_kesehatan/' . md5($val['id_kesehatan'])) ?>"><i class="icon-pencil3"></i>update</a>
                            </div>
                            <div class="col-md-12">
                                <a class="btn btn-outline-danger col-lg-8" href="<?= site_url('medis/delete_kesehatan/' . md5($val['id_kesehatan'])) ?>"><i class="icon-trash-alt"></i>delete</a>
                            </div>
                        </div>
                    </td>
                </tr>
        ...
        <a href="<?= site_url('medis/input_kesehatan') ?>" class="btn btn-lg btn btn-primary right-block">Tambah Data Kesehatan</a>
    </div>
</div>